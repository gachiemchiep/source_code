...
def get_armadillo_mesh():
    armadillo_path = _relative_path("/home/jil/opt/Open3D/Open3D/examples/TestData/Armadillo.ply")
...
def get_bunny_mesh():
    bunny_path = _relative_path("/home/jil/opt/Open3D/Open3D/examples/TestData/Bunny.ply")
...
def get_knot_mesh():
    mesh = o3d.io.read_triangle_mesh(_relative_path("/home/jil/opt/Open3D/Open3D/examples//TestData/knot.ply"))
    mesh.compute_vertex_normals()
    return mesh


def get_eagle_pcd():
    path = _relative_path("/home/jil/opt/Open3D/Open3D/examples/TestData/eagle.ply")
